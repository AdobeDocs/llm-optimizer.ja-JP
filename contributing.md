...
このプロジェクトはAdobe[&#x200B; 行動規範 &#x200B;](code-of-conduct.md) を遵守しています。 参加することにより、
...
プロジェクト コミッター別 [GitHub のプルリクエストドキュメントをお読みください &#x200B;](https://help.github.com/articles/about-pull-requests/)
プルリクエストの送信に関する詳細情報。
