...
[!UICONTROL Customer Configuration] ダッシュボードでは、カテゴリ（事業部門や商品ラインなど）のカスタマイズ、他のブランドのトラッキング、ブランド言及エイリアスの追加を行い、プロンプトをまたいでブランドのすべてのバリエーションを取り込むことができます。 この設定により、platform はビジネスコンテキストに合わせてインサイトを調整し、正確な表示、トラフィックおよび商談分析を可能にします。

## 業界プロンプトライブラリ

プロンプトやトピックを使い始めるために、Adobeは、業界の専門家との広範な調査と、6,000 人以上のお客様のAI 検索行動の分析を通じて開発された業界プロンプトライブラリを作成しました。 このライブラリは、業界固有のトレンド、検証済みのビジネス目標、実際の顧客検索パターンに基づいて、最も関連性の高いトピックとプロンプトを特定します。
...
* **カスタマーインテリジェンス：** 6,000 社以上のお客様のAI 検索の動作と好みを分析
...
LLM ツールのAI 検索とプロンプト動作に関するお客様の傾向：
