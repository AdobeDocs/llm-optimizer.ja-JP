...
* **トピック** - トピックカテゴリは、ブランドに関連する SEO キーワードとユーザーの質問を表します。 各トピックをクリックして展開し、ブランドのプレゼンスについて分析された個々のプロンプトを表示できます。 各トピックおよびボタンには、マウスポインターを合わせると、「**詳細** ボタンが表示されます。 ボタンをクリックすると、詳細を含む別のウィンドウが表示されます。
* **地域** - プロンプトの地域を表示します。
...
* **センチメント** – すべての週の平均として計算された各トピックに関連する、AI 応答のブランド認識。 ブランドが実際にメンションされたときにのみ入力
...
* **上位 5 社の競合企業** – 同じトピックで最も頻繁に言及された上位 5 社のブランド。 競合他社は、そのシェア・オブ・ボイス（最高から最低）によって編成されています。
